  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center gap-2 text-4xl font-bold">
            ...
            <span className="brand-text bg-clip-text">Commentator</span>
            <div className="absolute right-4 top-4">
              <ThemeToggle />
            </div>
          </div>
          <p className="text-muted-foreground">AI-Powered Social Media Engagement</p>
      ...
      <div className="fixed inset-0 -z-10 bg-background">
        <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/20 via-transparent to-red-500/20 opacity-30 dark:opacity-50" />
      </div>
    </div>
  );
}
